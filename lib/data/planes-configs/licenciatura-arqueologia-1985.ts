...
export const configuracionLicArqueologia1985: ConfiguracionPlan = {
  id: 'lic-arqueologia-1985',
  titulo: 'Plan de Estudios 1985 - Licenciatura en Antropología con orientación en Arqueología',
  descripción: 'Licenciatura en Antropología con orientación en Arqueología - Plan 1985',
  secciones: [
      ...
      if (seccion.id === 'materias') {
        return {
          ...
          tarjetas: [
            ...
            {
              id: 'licenciatura-arqueologia',
              titulo: 'Licenciatura Arqueología',
              descripcion: 'Seminario final de investigación',
              materias: [
                '0755' // SEMINARIO DE INVESTIGACIÓN EN ARQUEOLOGÍA
              ]
            }
          ]
        }
