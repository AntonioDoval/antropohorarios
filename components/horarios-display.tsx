      ...
      {seleccionFormateada.length > 0 && (
        <div className="mt-8">
          ...
          {(() => {
            ...
            const gridHeight = intervalos.length * 80 // 80px por cada fila
                ...
                <CardContent className="p-0">
                  <div className="relative">
                    <div className="overflow-x-auto">
                      ...
                      {/* Grid structure with relative positioning for absolute positioned cards */}
                      <div className="relative min-w-[900px]">
                        {/* Header */}
                        <div className="flex bg-uba-primary text-white">
                          <div className="w-[100px] border border-gray-300 p-3 text-center font-semibold text-sm">
                            Horario
                          </div>
                          {diasSemana.map((dia) => (
                            <div key={dia} className="flex-1 border border-gray-300 p-3 text-center font-semibold text-sm min-w-[140px]">
                              {dia}
                            </div>
                          ))}
                        </div>
                        ...
                        <div className="relative">
                          ...
                          {intervalos.map((intervalo) => (
                            <div key={intervalo.label} className="flex h-20">
                              <div className="w-[100px] border border-gray-300 p-2 text-center font-medium text-sm bg-gray-50 text-uba-primary">
                                {intervalo.label}
                              </div>
                              {diasSemana.map((dia) => (
                                <div key={dia} className="flex-1 border border-gray-300 p-1 align-top relative min-w-[140px]">
                                </div>
                              ))}
                            </div>
                          ))}
                          ...
                          {horariosCompletos.map((clase, index) => {
                            ...
                            return (
                              <div
                                key={index}
                                className={`absolute rounded-md border-2 p-1 text-xs overflow-hidden ${clase.color} z-10`}
                                style={{
                                  top: `${60 + topPosition}px`, // 60px is header height
                                  left: leftPosition,
                                  width: cardWidth,
                                  height: `${height}px`,
                                  minHeight: '24px'
