        ...
        <div className="flex justify-between items-center py-3">
          <MobileNav>
            <div className="flex flex-col space-y-4">
              {showPlanesEstudio && (
                <Link href="/planes-estudio" className="bg-uba-orange text-white px-4 py-2 rounded-lg hover:bg-uba-orange/90 transition-all duration-200 flex items-center gap-2">
                  Planes de estudio
                </Link>
              )}
              <div className="flex flex-col space-y-3 pt-4 border-t border-gray-200">
                <a href="https://filo.uba.ar" className="text-uba-red hover:text-uba-orange font-medium transition-all duration-200">filo.uba.ar</a>
                <a href="https://campus.filo.uba.ar/" className="text-uba-red hover:text-uba-orange font-medium transition-all duration-200">Campus Virtual</a>
                <a href="https://suiganew.filo.uba.ar/" className="text-uba-red hover:text-uba-orange font-medium transition-all duration-200">Inscripciones - SUIGA</a>
              </div>
            </div>
          </MobileNav>
